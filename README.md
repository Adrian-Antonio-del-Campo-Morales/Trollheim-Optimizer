...
[Descargar Trollheim Optimizer Portable 4.0.0](https://github.com/Adrian-Antonio-del-Campo-Morales/Trollheim-Optimizer/releases/download/v4.0.0/Trollheim-Optimizer-Portable-4.0.0.exe)

Para utilizarla:

1. Descarga `Trollheim-Optimizer-Portable-4.0.0.exe`.
...
La aplicación se centra exclusivamente en duelos cuerpo a cuerpo. Algunas
reglas poco comunes todavía están pendientes o se representan mediante una
aproximación; el detalle se mantiene en
